<template>
  <div id="CreatFinsh">
    ...
    <div class="padding-lg">
      ...
      <input v-model="name" onkeyup="this.value=this.value.replace(/[^\u4E00-\u9FA5]/g,'')"  type="text" name="firstname" class="text" min="2" maxlength="5"  placeholder="请输入一个名称"/>
      <div class="padding-md"></div>
      <div class="text-size-lg">注册手机号</div>
      <div class="padding-md"></div>

      <input v-model="mobile" onkeyup="this.value = this.value.replace(/\D/g,'')" min="11" maxlength="11"  type="tel" name="lastname" class="text"  placeholder="请输入您的手机号"/>
    </div>
